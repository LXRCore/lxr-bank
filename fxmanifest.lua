...
description 'LXRCore v3 bank: branch books on the core accounts, telegraph wires, drafts by account number, cheques, bank notes, society books that pay the wages'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-bank'
